...
function addDepartment() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(sql, [answer.name], (err) => {
        if (err) {
...
function addRole() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(sql, [answer.name, answer.wages, departmentId], (err) => {
        if (err) {
...
function addEmployee() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(sql, [answer.first_name, answer.last_name, roleId, managerId], (err) => {
        if (err) {
  ...
  connection.query(employeeQuery, (err, employeeResults) => {
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        connection.query(updateQuery, [answers.managerId, answers.employeeId], (err) => {
          if (err) {
...
function deleteDepartment() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(checkDependenciesQuery, [departmentId], (err, results) => {
        if (err) {
...
function deleteRole() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(checkDependenciesQuery, [roleId], (err, results) => {
        if (err) {
          console.error('Error checking dependencies: ' + err);
          return startPrompts();
        }
        ...
        connection.query(deleteQuery, [roleId], (err) => {
          if (err) {
...
function deleteEmployee() {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(checkDependenciesQuery, [employeeId], (err, results) => {
        if (err) {
          console.error('Error checking dependencies: ' + err);
          return startPrompts();
        }
